...
export default function Transition() {
  return (
    <section className="relative bg-black px-5 py-20 sm:px-8 sm:py-28 lg:py-32">
      {/* Below lg: full vertical stack — each word/star on its own centered line. Same
          five-item reveal sequence and delays as desktop. */}
      <div className="flex flex-col items-center gap-4 text-center sm:gap-5 lg:hidden">
        <Reveal>
